...
<head>
    <?php
    //cần thêm đoạn base này để lấy đc url gốc của ứng dụng
//    để khi sử dụng .htaccess không bị lỗi css, js, images
    ?>
...
<header class="header">
    <div class="header-wrapper">
        ...
        <div class="logo-box">
            <h1>
                <a href="<?php echo $_SERVER['SCRIPT_NAME']?>" class="logo"></a>
            </h1>
        </div>
        <!--logo end -->
        ...
        <div class="header-menu">
            ...
            <ul class="header-navigation" data-show-menu-on-mobile>
                <li>
                    <a href="<?php echo $_SERVER['SCRIPT_NAME']?>" class="material-button submenu-toggle">HOME</a>
